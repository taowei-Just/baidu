...
public class FastMysql {
    ...
    public FastMysql(String tableName) {
...
//            insertData(new TicletTab(), false);
    ...
    public PreparedStatement prepareUpdata(FastAllColor.Content  info) throws SQLException {
        String sql = "update   " + tableName + " set   resultInfo ='" + info.resultInfo + "' ,  sh='" + info.sh + "' , nn='" + info.nn
                + "' , issue=" + info.issue + " , openingTime ='" + info.openingTime + "'";
